...
plt_diff = plot(vec_diff_mean_strength_gpr[i_med], linewidth=4, xlabel="Time", ylabel="Change of mean strength", label="GP-EDM", legendfontcolor=:red, legendfontsize=18, legend=:bottomright)
