...
plt_diff = plot(vec_diff_mean_strength_gpr[i_med], linewidth=4, xlabel="Time", ylabel="Change of mean strength", label="GP-EDM", legendfontsize=18, legendfontcolor=:red, legend=:bottomright)
...
plt_diff = plot(vec_diff_mean_strength_gpr[i_med], linewidth=4, xlabel="Time", ylabel="Change of mean strength", label="GP-EDM", legendfontsize=18, legendfontcolor=:red, legend=:topleft)
plt_diff = plot!(plt_diff, vec_diff_mean_strength_true[i_med], linewidth=4, label="Ground truth")
...
plt_diff = plot(vec_diff_mean_strength_gpr[i_med], linewidth=4, xlabel="Time", ylabel="Change of mean strength", label="GP-EDM", legendfontsize=18, legendfontcolor=:red, legend=:bottom)
plt_diff = plot!(plt_diff, vec_diff_mean_strength_true[i_med], linewidth=4, label="Ground truth")
plt_diff = annotate!(plt_diff, [75], [0.02], text("Accuracy: $(round(vec_sign_diff_mean[i_med]*100, digits=1))%", 20))
plt_diff = hline!(plt_diff, [0], linestyle=:dash, colour=:black, linewidth=3, label=false)
