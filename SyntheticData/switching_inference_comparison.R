...
inference_jmat_smap <- get_stats_ver2(jmat_smap, list_jmat_scaled_switching)
inference_jmat_rsmap <- get_stats_ver2(jmat_rsmap, list_jmat_scaled_switching)
inference_jmat_gpr <- get_stats_ver2(jmat_gpr, list_jmat_scaled_switching)
